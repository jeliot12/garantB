...
# bot token
BOT_TOKEN = "8241159244:AAHpaYiCUBM2bleEoWLmG4s8oNmGhEkVaa8"
    ...
    if user_id in user_deal_data:
        ...
        if user_lang == "en":
            success_text = (
                ...
                f"🔗 Link for buyer: http://t.me/GlftElfIBot?start={deal_id}"
            )
        else:
            success_text = (
                ...
                f"🔗 Ссылка для покупателя: http://t.me/GlftElfIBot?start={deal_id}"
            )
...
def get_referral_text(user_id, lang="ru"):
    ...
    if lang == "en":
        return (
            ...
            f"http://t.me/GlftElfIBot?start=ref_{user_id}\n\n"
